...
from ..LLMClient.llama3 import llama_completion
import SQL_Agent
...
def master_main(message: str, history: List[Tuple[str, str]]):
        system_msg = "You are hired as a data scientist on a new VALORANT esports team and have been tasked by the team's general manager to support the scouting and recruitment process."
